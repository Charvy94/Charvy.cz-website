  ...
  const cards = [
    {
      ...
      gradient: 'from-photo-secondary to-photo-primary'
    },
    {
      id: 'workshop',
      title: t('home.workshopCard'),
      desc: t('home.workshopDesc'),
      gradient: 'from-workshop-secondary to-workshop-primary'
    },
    {
      id: 'blog',
      title: t('home.blogCard'),
      desc: t('home.blogDesc'),
      gradient: 'from-blog-accent to-blog-primary'
    },
    {
      id: 'ttrpg',
      title: t('home.ttrpgCard'),
      desc: t('home.ttrpgDesc'),
      gradient: 'from-ttrpg-secondary to-ttrpg-primary'
    }
  ];
